...
def transformation():
	...
	sx=input("Enter sx: ")
	sy=input("Enter sy: ")
	Srefpoint_x=input("Enter reference point_x: ")
	Srefpoint_y=input("Enter reference point_y: ")
	scale(sx,sy,Srefpoint_x,Srefpoint_y)
	print("1.Anticlockwise rotation \n2.clockwise rotation")
	direction=int(input("Select direction: "))
	theta=float(input("Enter theta: "))
	Rrefpoint_x=input("Enter reference point_x: ")
	Rrefpoint_y=input("Enter reference point_y: ")
	if direction==1:
		rotate(theta,Rrefpoint_x,Rrefpoint_y)
	elif direction==2:
		rotate(-theta,Rrefpoint_x,Rrefpoint_y)
